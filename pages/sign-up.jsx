...
لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف به
                </p>
              </div>
              <div className="flex justify-between items-center w-full">
                ...
                ><bdi>متن قرارداد را مطالعه کردم و با مفاد آن موافق هستم</bdi></label>
                <input 
                  id="contractCheck"
                  type='checkbox'
                  // onChange={formik.handleChange}
    ...
    case 6:
      return (
        <Layout backHandler={backHandler} step={step} title={"فروشنده عزیز، با سپاس از همراهی شما"}>
            <div className="w-full">
              ...
              بررسی مدارک توسط بازرس پتمون انجام می شود.
                 در صورت <span className="text-verify">تایید</span>، حساب کاربری شما فعال خواهد شد.
              </p>
              <button
