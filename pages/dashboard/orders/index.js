...
const Orders = () => {
    ...
    return (
        <div>
            ...
            <DashboardLayout>
                {/* Main page */}   
                <div className={clsx('flex flex-col h-full items-stretch',{
                    ...
                    {!data ? 
                        <div className='flex flex-col items-stretch'>
                            ...
                            <p className='text-xl text-gray-400 font-normal leading-10 mt-8'>
                                <bdi>مشاهده <Link href='/' className='text-info underline'>سفارش های تکمیل شده</Link></bdi>
                            </p>
                        </div>
                    :
                    <div>
                            ...
                            {data && data.map((item,index) => 
                                <div key={v4()} className='flex flex-col items-stretch w-full my-1 p-5 bg-white border-[1px] border-secondary rounded-[15px] shadow-shadowB'>
                                    ...
                                    <div className='grid grid-cols-2 gap-y-1 mt-4'>
                                        ...
                                        <div className='flex items-center'>
                                            <p className='text-sm text-black font-medium leading-5 ml-2'><bdi>کد سفارش</bdi></p>
                                            <p className='text-xs text-gray-400 font-medium leading-4'><bdi>{item.orderCode}</bdi></p>
                                        </div>
                                        <div className='flex items-center'>
                                            <p className='text-sm text-black font-medium leading-5 ml-2'><bdi>نام کاربر</bdi></p>
                                            <p className='text-xs text-gray-400 font-medium leading-4'><bdi>{item.userFullname}</bdi></p>
                                        </div>
                                        <div className='flex items-center'>
                                            <p className='text-sm text-black font-medium leading-5 ml-2'><bdi>مبلغ</bdi></p>
                                            <p className='text-xs text-gray-400 font-medium leading-4 after:content-["تومان"] after:text-[10px] after:mr-1'><bdi>{(+item.ordersSum).toLocaleString()}</bdi></p>
                                        </div>
                                        <div className='flex items-center'>
                                            <p className='text-sm text-black font-medium leading-5 ml-2'><bdi>تخفیف</bdi></p>
                                            <p className='text-xs text-gray-400 font-medium leading-4 after:content-["تومان"] after:text-[10px] after:mr-1'><bdi>{(+item.discount).toLocaleString()}</bdi></p>
                                        </div>
                                        <div className='flex items-center'>
                                            <p className='text-sm text-black font-medium leading-5 ml-2'><bdi>تاریخ</bdi></p>
                                            <p className='text-xs text-gray-400 font-medium leading-4'><bdi>{item.date}</bdi></p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className='flex justify-between px-10 py-8 w-full'>
                                ...
                                <div className='flex'>
                                    <div className='flex items-center px-3 py-2 ml-2 border-[1px] border-primary rounded-[12px]'>
                                        <p className='text-base text-primary font-medium leading-5 ml-10'><bdi>فیلتر تاریخ</bdi></p>
                                        ...
                                        <tr key={v4()} className='border-b-[1px] border-[#D9D9D9] mx-5'>
                                            ...
                                            <td className='flex justify-center items-center m-auto py-10'>
                                                <div className='flex items-center justify-center text-xs text-verify font-medium leading-4 w-auto px-2 py-1.5 bg-[#3BD8834D] border-verify border-[1px] rounded-[5px]'>
                                                    ...
                                                    <Image src={tick_Icon} alt="Order Status" className='mr-5'/>
                                                </div>
