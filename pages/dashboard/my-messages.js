  ...
  const [messagesArr, setMessagesArr] = useState([
    {
      ...
      from: "پیام از پتمون",
      date: "۱۸ آبان ۱۴۰۰",
      subject: "نظراتت برای بهبود سرویس دهی پتمون با ارزشه",
      text: "لطفا نظرت رو با ما به اشتراک بذار...",
      CTA: "ثبت نظر",
    },
    {
      key: 1,
      from: "پیام از پتمون",
      date: "۱۰ آبان ۱۴۰۰",
      subject: "تخفیف ویژه فروشگاه از ۲۰ آبان",
      text: "تخفیف ها رو فراموش نکن...",
      CTA: "فروشگاه",
    },
    {
      key: 2,
      from: "پیام از پتمون",
      date: "۰۲ مهر ۱۴۰۰",
      subject: "سایت پتمون از یکشنبه تا سه شنبه در دست تعمیر",
      text: "ممنون از حمایت و همراهی شما...",
    },
