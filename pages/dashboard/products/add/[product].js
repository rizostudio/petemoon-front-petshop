...
const SingleProduct = () => {
    ...
    const data = {name:"غذای خشک سگ های خانگی",group:"دسته خوراکی / سگ",commentsNumber:250, stars:3, price:123000, discount:20, amount:10,
        property:[{name:"for", title:"مخصوص", value:"سگ خانگی"},{name:"kind", title:"نوع", value:"خوراکی حیوانی"}, {name:"MadeIn", title:"کشور سازنده", value:"تایوان"},{name:"dimension", title:"ابعاد", value:"۲۰۰۰*۱۰۰۰"}, {name:'weight', title:'وزن', value:2000},], 
                ...
                <div className='flex flex-col justify-between items-stretch w-full'>
                    ...
                    <div className='flex lg:hidden flex-row justify-between items-center py-5'>
                        <div className='flex flex-col justify-end'>
                            <div className='flex flex-row items-center'>
                                <h2 className='text-base text-black font-black leading-7 opacity-90 before:inline-block before:w-2 before:h-5 before:bg-primary before:ml-1 before:align-middle before:rounded-[2px]'>{data.name}</h2>
                            ...
                            <div className='flex flex-col justify-between mt-5'>
                                ...
                                <div className='pb-3 my-2 order-2 lg:order-1 border-none lg:border-solid border-b-[2px] border-secondary'>
                                    ...
                                    {data.property.map((item,index) => 
                                        <div key={index} className='lg:hidden flex flex-row items-center align-middle my-1 mr-5'>
                                    ...
                                    {data.property.slice(0,2).map((item,index) => 
                                        <div key={index} className='hidden lg:flex flex-row items-center align-middle my-1 mr-5'>
                                            <p className='text-base lg:text-lg text-gray-400 font-bold leading-7 opacity-90 before:content-["."] before:text-4xl before:ml-2'><bdi>{item.title}</bdi></p>
                                            <p className='text-base lg:text-lg text-black font-bold leading-7 opacity-90 mr-4 lg:mr-2 align-bottom'><bdi>{item.value}</bdi></p>
                                        </div>
                                    )}
                                ...
                                <div className='hidden lg:flex flex-col items-stretch order-1 w-full mb-3 py-5'>
                                    <div className='flex items-center justify-between w-full my-2 px-5 py-0.5 border-[1px] border-primary rounded-[15px]'>
                                        <p className='text-lg text-primary font-bold leading-7'><bdi>قیمت را وارد نمایید:</bdi></p>
                                        <div className='flex items-center'>
                                            ...
                                            />
                                            <p className='text-sm text-primary font-normal leading-7'><bdi>تومان</bdi></p>
                                        </div>
                                    </div>
                                    <div className='flex items-center justify-between w-full my-2 px-5 py-0.5 border-[1px] border-primary rounded-[15px]'>
                                        <p className='text-lg text-primary font-bold leading-7'><bdi>موجودی را وارد نمایید:</bdi></p>
                                        <div className='flex items-center'>
                                            <input
                                                type='number'
                                                className='text-2xl text-primary font-medium leading-10 opacity-90 w-[100px] bg-transparent appearance-none border-none focus:outline-none focus:ring-0 focus:border-none peer'
                                            />
                                            <p className='text-sm text-primary font-normal leading-7'><bdi>عدد</bdi></p>
                                        </div>
                                    </div>
                    ...
                    <div className='lg:hidden flex flex-col items-stretch justify-between w-full h-full mt-10 mb-[100px]'>
                        <div className='flex flex-col items-stretch'>
                            <div className='flex items-center justify-between w-full my-2 px-5 py-0.5 border-[1px] border-primary rounded-[15px]'>
                                <p className='text-base lg:text-lg text-primary font-bold leading-7'><bdi>قیمت را وارد نمایید:</bdi></p>
                                <div className='flex items-center'>
                                    <input
                                        type='number'
                            ...
                            <div className='flex items-center justify-between w-full my-2 px-5 py-0.5 border-[1px] border-primary rounded-[15px]'>
                                <p className='text-base lg:text-lg text-primary font-bold leading-7'><bdi>موجودی را وارد نمایید:</bdi></p>
                                <div className='flex items-center'>
                                    <input
                                        type='number'
                                        className='text-base lg:text-2xl text-primary font-medium leading-10 opacity-90 w-[100px] bg-transparent appearance-none border-none focus:outline-none focus:ring-0 focus:border-none peer'
