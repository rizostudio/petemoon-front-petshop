...
const BottomNavigation = () => {
    const menuArr = [   
        ...
        {id:"my-messages", name:"پیام های من", icon:messageGray_Icon, notification:10},
    ]
            ...
            {menuArr.map((item,index) => 
                ...
                >
                    <Image 
                        ...
                        alt="Home Icon"
                        />
                    <h3 className='text-sm text-center text-gray-400 font-medium leading-5 mt-1'><bdi>{item.name}</bdi></h3>
                </Link>
            )}
        </div>
    );
